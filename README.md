...
В данном репозитории находятся переводы от команды ocStore которые можна использовать для оригинального OpenCart
...
Распаковать содержимое архива соответствущей версии на сервер и установить следующие значения для языка:
